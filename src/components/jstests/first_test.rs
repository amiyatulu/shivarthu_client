...
use crate::constants::auth::{HF_ACCESS_TOKEN,EVERLAND_CREDENTIALS} ;
use crate::constants::constant::{HUGGING_FACE_MODEL, NODE_URL, EVERLAND_ENDPOINT};
        ...
        move |_| {
            let timeout = Timeout::new(1_000, move || {
                wasm_bindgen_futures::spawn_local(async move {
                    ...
                    let promisedata = js_extension_binding::upload_file_4everland(endpoint, bucket, folder, data, file_name, key, secret, session_token);
