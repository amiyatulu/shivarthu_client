    ...
    use_effect_with((), move |_| {
        let timeout = Timeout::new(1_000, move || {
            wasm_bindgen_futures::spawn_local(async move {
                ...
                let promise_cid = js_extension_binding::upload_pin_string_4everland(bucket_endpoint, pinning_url, bucket, folder, data, file_name, access_key, secret_access, session_token, pin_secret);
