...
use yew::prelude::*;
use std::ops::Deref;
use crate::components::positive_externality_validation::commit_vote_positive_externality_transaction_condition::ConditionalTransactionModal;
...
pub fn commit_vote(props: &Props) -> Html {
    ...
    if *submit_done_clone == false {
        ...
        html! {
            <>
            <ConditionalTransactionModal hash={hash} user_to_calculate={user_to_calculate}/>
            </>
        }
    }
}
