...
use json::object;
use yew::prelude::*;
use crate::components::positive_externality_validation::create_positive_externality_post_transaction_condition::ConditionalTransactionModal;


#[function_component(CreatePositiveExternalityPost)]
pub fn create_positive_externality_post() -> Html {
