    ...
    let pagination_range = use_memo(
        ...
        move |_| {
            let total_page_count =
                (props_clone.total_count + props_clone.page_size - 1) / props_clone.page_size;
            ...
            let left_sibling_index = props_clone
                .current_page
                .saturating_sub(props_clone.sibling_count);
            let right_sibling_index =
                (props_clone.current_page + props_clone.sibling_count).min(total_page_count);
            ...
            if !should_show_left_dots && should_show_right_dots {
                ...
                return [
                    &left_range[..],
                    &[PageRange::DOTS],
                    &[PageRange::Value(total_page_count)],
                ]
                .concat();
            }
            ...
            if should_show_left_dots && !should_show_right_dots {
                ...
                let right_range = range(
                    total_page_count.saturating_sub(right_item_count) + 1,
                    total_page_count,
                );

                return [
                    &[PageRange::Value(first_page_index)],
                    &[PageRange::DOTS],
                    &right_range[..],
                ]
                .concat();
            ...
            if should_show_left_dots && should_show_right_dots {
                ...
                return [
                    ...
                    &middle_range[..],
                    &[PageRange::DOTS],
                    &[PageRange::Value(last_page_index)],
                ]
                .concat();
            }
