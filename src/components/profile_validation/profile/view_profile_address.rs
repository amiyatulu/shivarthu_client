...
#[styled_component(ViewProfileAddress)]
pub fn view_profile_address(props: &Props) -> Html {
    let stylesheet = Style::new(STYLE_FILE).unwrap();
    let account_id = props.profile_user_account.clone();
    let profile_user_account_clone = account_id.clone();
    ...
    html! {
        ...
        <br/>
        <div>
        <Link<Route> to={Route::SchellingGame {profile_user_account: profile_user_account_clone}} classes="btn btn-success btn-lg btn-block">{"Schelling Game"}</Link<Route>>
