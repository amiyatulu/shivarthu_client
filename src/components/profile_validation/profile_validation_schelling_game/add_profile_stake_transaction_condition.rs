...
pub fn transaction(props: &Props) -> Html {
    ...
    let add_profile_stake = polkadot::tx()
        .profile_validation()
        .add_profile_stake(account_id32, amount_to_fund.into());
...
pub fn transaction_extension(props: &ExtensionProps) -> Html {
    ...
    let hookdata = use_sign_tx_extension(add_profile_stake, account_address, account_source);
    html! {
        <>
