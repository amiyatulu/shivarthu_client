...
export async function challege_profile(wsprovider, mnemonic, profile_user_account, ipfs_string) {
    ...
    return new Promise((resolve, reject) => {
        ...
        apiPromise.then((api) => {
            ...
            api.tx.profileValidation.challegeProfile(profile_user_account, content)
