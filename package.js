...
import { getSTSCredentials } from './js_api/4everland_s3/sts_credentials';
import { uploadFile4everland } from './js_api/4everland_s3/upload_file';


await waitReady();
export { transfer_balance, get_api, get_account_address_from_seed, helloworld, add_profile, chat_text, add_profile_stake, challege_profile, getAccounts, signPayload, getSTSCredentials, uploadFile4everland}
